...
Note that the letter `X` is used here instead of the exact image set name because the Visual Behavior Ophys project used different image sets in different mice. See the <b>**Visual Behavior Ophys**</b> page for more information on dataset variants. 
