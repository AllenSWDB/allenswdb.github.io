...
Full-field sinusoidal gratings drifting in one of eight directions at several temporal frequencies. Used to characterize direction and temporal-frequency tuning.
...
Briefly flashed non-drifting sinusoidal gratings varying in orientation, spatial frequency, and phase. Used to characterize orientation and spatial-frequency tuning.
...
A set of grayscale photographs, each briefly flashed. Used to characterize responses to complex naturalistic images.
...
### Gabors (receptive-field mapping)
